import{r as p,o as H,g as ne,a as o,c as l,d as e,t as s,F as v,h as C,i as t,j as se,k as ie,p as A,l as L,m as q,n as de,w as u,q as m,u as ce,b as re,s as G}from"./index-YgCGO-X6.js";import{_ as T,H as ue}from"./Header-I-H_lyMs.js";const M="/default.png",c=h=>(A("data-v-f9e7642a"),h=h(),L(),h),pe={class:"wcp-demo-container"},me={class:"demo-row"},he=["disabled"],we=["disabled"],ve={class:"demo-row"},be=c(()=>e("w-input",{placeholder:"username",style:{"margin-right":"10px","margin-bottom":"10px"}},null,-1)),ge=c(()=>e("w-input",{type:"password",style:{"margin-right":"10px","margin-bottom":"10px"},placeholder:"password"},null,-1)),ye=c(()=>e("w-input",{type:"date",value:"2024-01-01",style:{"margin-right":"10px","margin-bottom":"10px"}},null,-1)),fe=c(()=>e("w-input",{type:"time",value:"00:00",style:{"margin-right":"10px","margin-bottom":"10px"}},null,-1)),_e=["value"],xe=c(()=>e("w-input",{type:"number",style:{width:"80px","margin-right":"10px","margin-bottom":"10px"},min:"0",placeholder:"age"},null,-1)),ke=["value"],Ce=c(()=>e("optgroup",{label:"Gender"},[e("option",{value:"1"},"male"),e("option",{value:"2"},"female"),e("option",{value:"3",disabled:""},"other")],-1)),je=[Ce],We=["value"],$e={class:"demo-row"},Se=["value"],ze=c(()=>e("w-radio",{value:"1"},"male",-1)),Ae=c(()=>e("w-radio",{value:"2"},"female",-1)),Le=c(()=>e("w-radio",{disabled:"",value:"3"},"other",-1)),qe=[ze,Ae,Le],Te={class:"demo-row"},Me=["value"],Ee={class:"demo-row"},Be={class:"demo-row"},Ie=["value"],Re=["value"],De={class:"demo-row"},Fe=["value"],Pe=c(()=>e("w-tab",{value:"tab1"},"tab1",-1)),Ge=c(()=>e("w-tab",{value:"tab2"},"tab2",-1)),He=c(()=>e("w-tab",{value:"tab3",disabled:""},"tab3",-1)),Ne=[Pe,Ge,He],Ve={class:"demo-row"},Ue=q('<div slot="header" data-v-f9e7642a>header</div><div slot="body" style="display:flex;flex-direction:column;overflow:hidden;" data-v-f9e7642a><div data-v-f9e7642a>body</div><div style="overflow-y:auto;" data-v-f9e7642a><div style="height:400px;" data-v-f9e7642a>scroll</div></div></div><div slot="footer" data-v-f9e7642a><div style="display:flex;width:100%;justify-content:center;" data-v-f9e7642a> footer </div></div>',3),Oe=[Ue],Je={class:"demo-row"},Ke={style:{position:"relative"}},Qe=["show"],Xe=c(()=>e("w-menu-item",{style:{"border-top":"1px solid #ddd"},disabled:""},"menu c",-1)),Ye={class:"demo-row"},Ze=c(()=>e("w-btn",null,"upload",-1)),et=[Ze],tt=c(()=>e("w-btn",null,"accept multiple",-1)),ot=[tt],lt=c(()=>e("w-upload",{url:"/api/upload",disabled:""},[e("w-btn",{disabled:""},"disabled")],-1)),at={class:"demo-row"},nt={style:{"background-color":"#fff","margin-top":"10px"}},st=["columns"],it=c(()=>e("w-table-item",{style:{"background-color":"black",color:"#fff"}},"name",-1)),dt=c(()=>e("w-table-item",{style:{"background-color":"rgb(190, 15, 15)",color:"#fff"}},"age",-1)),ct=c(()=>e("w-table-item",{style:{"background-color":"rgb(59, 60, 153)",color:"#fff"}},"interest",-1)),rt=[it,dt,ct],ut={style:{height:"100px","overflow-y":"auto"}},pt=["columns"],mt=c(()=>e("div",{class:"demo-row"},[e("w-player",{style:{width:"400px",height:"260px","max-width":"100%"},src:"https://cdn.openai.com/tmp/s/interp/e1.mp4"})],-1)),ht=c(()=>e("div",{class:"demo-row"},[e("w-slide",{style:{width:"400px",height:"300px","max-width":"100%"},auto:""},[e("w-slide-item",{style:{"background-color":"#000",color:"#fff"}},[e("div",{item:"1",style:{display:"flex","justify-content":"center","align-items":"center",width:"100%",height:"100%"}}," 1 ")]),e("w-slide-item",{style:{"background-color":"#333",color:"#fff"}},[e("div",{item:"2",style:{display:"flex","justify-content":"center","align-items":"center",width:"100%",height:"100%"}}," 2 ")]),e("w-slide-item",{style:{"background-color":"#666",color:"#fff"}},[e("div",{item:"3",style:{display:"flex","justify-content":"center","align-items":"center",width:"100%",height:"100%"}}," 3 ")])])],-1)),wt={class:"demo-row"},vt={style:{width:"400px",height:"300px","max-width":"100%"}},bt={style:{display:"flex",height:"100%"}},gt={style:{height:"100%"},src:M,"lazy-src":"/bg.png"},yt={class:"demo-row"},ft={style:{display:"flex"}},_t={style:{display:"inline-flex",height:"100%",width:"100%"}},xt=c(()=>e("img",{style:{height:"100%"},src:M},null,-1)),kt={class:"demo-row"},Ct={style:{display:"flex","flex-direction":"column"}},jt={style:{display:"inline-flex"}},Wt=c(()=>e("img",{style:{width:"100%"},src:M},null,-1)),$t=[Wt],St=c(()=>e("div",{slot:"loading",style:{"text-align":"center"}},"loading",-1)),zt={__name:"WebComponentsPlusDemo",setup(h){const a=p(""),b=p("#1abc8c"),g=p("1"),n=p("like football and cooking"),w=p("1"),f=p("on"),W=p(["apple","banana","orange"]),y=p([]),S=p([]),_=p("tab1"),E=p(null),z=p(null),B=p(null),x=p(null),$=p(.2),I=p([{name:"pony",age:18,interest:"football"}]);for(let i=0;i<100;i++)I.value.push({name:"pony",age:18,interest:"football"});const R=p("100px 100px 1fr"),D=p([{}]),F=p([{}]);function V(i){b.value=i.detail.value,se.initColor(b.value)}function U(i){g.value=i.detail.value}function O(i){n.value=i.detail.value}function J(i){w.value=i.detail.value}function K(i){let d=i.target.getAttribute("value");if(i.target.hasAttribute("checked"))y.value.push(d);else{let r=y.value.filter((k,No)=>k!=d);y.value.length=0,y.value.push(...r)}}function Q(i){i.target.hasAttribute("checked")?(y.value.length=0,S.value.forEach(d=>{d.setAttribute("checked",""),y.value.push(d.getAttribute("value"))})):(y.value.length=0,S.value.forEach(d=>{d.removeAttribute("checked")}))}function X(i){f.value=i.detail.value}function Y(i){console.log("tabs change",i.detail.value),_.value=i.detail.value}function Z(i){z.value.setAttribute("show","")}function ee(i){B.value.setAttribute("show","")}function te(i){x.value=x.value==""?null:""}function oe(){ie("delete?",i=>{E.value.show("success")})}function le(){D.value.push({})}function ae(){F.value.push({})}async function P(i){console.log(i.detail)}return H(()=>{}),ne(()=>{}),(i,d)=>(o(),l("div",pe,[e("div",me,[e("w-btn",{style:{"margin-right":"10px"},onClick:d[0]||(d[0]=r=>a.value=a.value==""?null:"")},"default"),e("w-btn",{style:{"margin-right":"10px"},type:"outline",disabled:a.value},"outline",8,he),e("w-btn",{type:"text",disabled:a.value},"text",8,we)]),e("div",ve,[be,ge,ye,fe,e("w-input",{type:"color",value:b.value,onChange:V,style:{width:"40px",height:"35px","margin-right":"10px","margin-bottom":"10px"}},null,40,_e),xe,e("w-select",{value:g.value,onChange:U,style:{"margin-right":"10px","margin-bottom":"10px"}},je,40,ke),e("w-textarea",{value:n.value,onChange:O},null,40,We),e("div",null,s(n.value),1)]),e("div",$e,[e("w-radios",{value:w.value,onChange:J},qe,40,Se),e("div",null,s(w.value),1)]),e("div",Te,[(o(!0),l(v,null,C(W.value,r=>(o(),l("w-checkbox",{ref_for:!0,ref_key:"checkboxRef",ref:S,value:r,onChange:d[1]||(d[1]=k=>K(k))},s(r),41,Me))),256)),e("w-checkbox",{onChange:Q},"all",32),e("div",null,s(y.value),1)]),e("div",Ee,[e("w-toggle",{on:"",onChange:X},null,32),e("div",null,s(f.value),1)]),e("div",Be,[e("w-heart",{value:$.value,onChange:d[2]||(d[2]=r=>{$.value=r.detail.value,console.log(r.detail.value)})},null,40,Ie),e("w-heart",{disabled:"",value:$.value},null,8,Re),e("div",null,s($.value),1)]),e("div",De,[e("w-tabs",{value:_.value,onChange:Y},Ne,40,Fe),e("div",null,[_.value=="tab1"?(o(),l(v,{key:0},[t(" tab1 ")],64)):_.value=="tab2"?(o(),l(v,{key:1},[t(" tab2 ")],64)):_.value=="tab3"?(o(),l(v,{key:2},[t(" tab3 ")],64)):(o(),l(v,{key:3},[],64))])]),e("div",Ve,[e("w-btn",{onClick:Z},"modal"),e("w-btn",{onClick:ee,style:{margin:"0 10px"}},"dialog"),e("w-btn",{onClick:oe},"confirm"),e("w-msg",{ref_key:"msg",ref:E},null,512),e("w-modal",{ref_key:"modal",ref:z},[e("div",null,[e("w-btn",{onClick:d[3]||(d[3]=r=>z.value.removeAttribute("show"))},"hide")])],512),e("w-dialog",{ref_key:"dialog",ref:B},Oe,512)]),e("div",Je,[e("div",Ke,[e("w-btn",{onClick:te},"menu"),e("w-menu",{show:x.value,style:{top:"40px",left:"0"}},[e("w-menu-item",{onClick:d[4]||(d[4]=r=>x.value=null)},"item a"),e("w-menu-item",{onClick:d[5]||(d[5]=r=>x.value=null)},"item b"),Xe],8,Qe)])]),e("div",Ye,[e("w-upload",{onChange:d[6]||(d[6]=r=>P(r)),url:"/api/upload"},et,32),e("w-upload",{style:{margin:"0 10px"},onChange:d[7]||(d[7]=r=>P(r)),url:"/api/upload",accept:".png,.jpg",multiple:"",name:"img"},ot,32),lt]),e("div",at,[e("div",nt,[e("div",null,[e("w-table-row",{columns:R.value},rt,8,st)]),e("div",ut,[(o(!0),l(v,null,C(I.value,r=>(o(),l("w-table-row",{columns:R.value,hover:""},[e("w-table-item",null,s(r.name),1),e("w-table-item",null,s(r.age),1),e("w-table-item",null,s(r.interest),1)],8,pt))),256))])])]),mt,ht,e("div",wt,[e("w-lazy-loading",vt,[e("div",bt,[(o(),l(v,null,C([1,2,3],r=>e("img",gt)),64))])])]),e("div",yt,[e("w-scroll-loading",{style:{width:"400px",height:"300px","max-width":"100%"},onChange:le},[e("div",ft,[(o(!0),l(v,null,C(D.value,(r,k)=>(o(),l("div",_t,[xt,t(" "+s(k),1)]))),256))])],32)]),e("div",kt,[e("w-scroll-loading",{style:{width:"400px",height:"300px","max-width":"100%","flex-direction":"column"},onChange:ae},[e("div",Ct,[(o(!0),l(v,null,C(F.value,r=>(o(),l("div",jt,$t))),256))]),St],32)])]))}},At=T(zt,[["__scopeId","data-v-f9e7642a"]]),j=h=>(A("data-v-8718deca"),h=h(),L(),h),Lt={class:"wcp-doc-container"},qt={style:{"overflow-x":"auto","scrollbar-width":"none"}},Tt=["value"],Mt=q('<w-tab value="install" data-v-8718deca>install</w-tab><w-tab value="w-btn" data-v-8718deca>w-btn</w-tab><w-tab value="w-input" data-v-8718deca>w-input</w-tab><w-tab value="w-select" data-v-8718deca>w-select</w-tab><w-tab value="w-textarea" data-v-8718deca>w-textarea</w-tab><w-tab value="w-radio" data-v-8718deca>w-radio w-radios</w-tab><w-tab value="w-checkbox" data-v-8718deca>w-checkbox</w-tab><w-tab value="w-toggle" data-v-8718deca>w-toggle</w-tab><w-tab value="w-tab" data-v-8718deca>w-tab w-tabs</w-tab><w-tab value="w-msg" data-v-8718deca>w-msg</w-tab><w-tab value="w-modal" data-v-8718deca>w-modal</w-tab><w-tab value="w-dialog" data-v-8718deca>w-dialog</w-tab><w-tab value="confirm" data-v-8718deca>Confirm</w-tab><w-tab value="w-menu" data-v-8718deca>w-menu w-menu-item</w-tab><w-tab value="w-lazy-loading" data-v-8718deca>w-lazy-loading</w-tab>',15),Et=[Mt],Bt=j(()=>e("h3",null,"npm",-1)),It=j(()=>e("code",null,"npm install web-components-plus",-1)),Rt=j(()=>e("code",null,`import { Core, WBtn } from 'web-components-plus'

Core.initColor()
`,-1)),Dt=j(()=>e("h3",null,"browser",-1)),Ft=j(()=>e("code",null,`import { Core, WBtn } from 'https://unpkg.com/web-components-plus@1/main.js'

Core.initColor()
`,-1)),Pt={key:1},Gt={key:2},Ht={key:3},Nt={key:4},Vt={key:5},Ut={key:6},Ot={key:7},Jt={key:8},Kt={key:9},Qt={key:10},Xt={key:11},Yt={key:12},Zt={key:13},eo={key:14},to=["value"],oo={key:0},lo={style:{"overflow-x":"auto","scrollbar-width":"none"}},ao=["value"],no=q('<w-tab value="w-upload" data-v-8718deca>w-upload</w-tab><w-tab value="w-table-row" data-v-8718deca>w-table-row w-table-item</w-tab><w-tab value="w-player" data-v-8718deca>w-player</w-tab><w-tab value="w-scroll-loading" data-v-8718deca>w-scroll-loading</w-tab><w-tab value="w-heart" data-v-8718deca>w-heart</w-tab><w-tab value="fetch" data-v-8718deca>fetch</w-tab>',6),so=[no],io={key:0},co={key:1},ro={key:2},uo={key:3},po={key:4},mo={key:5},ho=`// js
<html>
    <body>
        <w-btn>default</w-btn>
    ...
    <body>
        <div style="background-color: #fff; margin-top: 10px;">
            ...
            <div style="height: 100px; overflow-y: auto;">
                ...
                <w-table-row columns="100px 100px 1fr" hover>
                    <w-table-item>pony</w-table-item>
                    <w-table-item>18</w-table-item>
                    <w-table-item>cooking</w-table-item>
                </w-table-row>
            </div>
        </div>
        <script type="module">
...
<script setup>
    ...
    const data = ref([
        { name: 'jack', age: 18, interest: 'cooking' },
        { name: 'pony', age: 18, interest: 'football' },
    ])
...
<script setup>
    ...
    Fetch.setOptions({ headers: { authorization: 'auth' } })
        ...
        let result = await res.json()
        console.log(result)
<\/script>`,Mo={__name:"WebComponentsPlusDoc",setup(h){const a=p({code:"",base:"install",highComponent:"w-player"});return H(b=>{}),(b,g)=>{const n=de("highlight");return o(),l("div",Lt,[e("div",qt,[e("w-tabs",{style:{width:"max-content",display:"block"},value:a.value.base,onChange:g[0]||(g[0]=w=>{a.value.base=w.detail.value})},Et,40,Tt)]),e("div",null,[a.value.base=="install"?(o(),l(v,{key:0},[Bt,u((o(),l("pre",null,[t("                        "),It,t(`
                        `),Rt,t(`
                `)])),[[n]]),Dt,u((o(),l("pre",null,[t("                        "),Ft,t(`
                `)])),[[n]])],64)):m("",!0),a.value.base=="w-btn"?u((o(),l("pre",Pt,[t("                        "),e("code",null,s(ho)),t(`
| attr | value |
| --- | --- |
...
| size | default/sm/lg |
| disabled | boolean |
                    `)])),[[n]]):m("",!0),a.value.base=="w-input"?u((o(),l("pre",Gt,[t("                        "),e("code",null,s(wo)),t(`
| attr | value |
| --- | --- |
...
| error | boolean |
| change | event |
                    `)])),[[n]]):m("",!0),a.value.base=="w-select"?u((o(),l("pre",Ht,[t("                        "),e("code",null,s(vo)),t(`
| attr | value |
| --- | --- |
| value | string |
| size | sm (default) lg |
| disabled | boolean |
| change | event |
                    `)])),[[n]]):m("",!0),a.value.base=="w-textarea"?u((o(),l("pre",Nt,[t("                        "),e("code",null,s(bo)),t(`
| attr | value |
| --- | --- |
| value | string |
| placeholder | string |
...
| error | boolean |
| change | event |
                    `)])),[[n]]):m("",!0),a.value.base=="w-radio"?u((o(),l("pre",Vt,[t("                        "),e("code",null,s(go)),t(`
| attr | value |
| --- | --- |
| value | string |
| size | default/sm/lg |
...
| value | string |
| change | event |
                    `)])),[[n]]):m("",!0),a.value.base=="w-checkbox"?u((o(),l("pre",Ut,[t("                        "),e("code",null,s(yo)),t(`
| attr | value |
| --- | --- |
| value | string |
| checked | boolean |
...
| disabled | boolean |
| change | event |
                    `)])),[[n]]):m("",!0),a.value.base=="w-toggle"?u((o(),l("pre",Ot,[t("                        "),e("code",null,s(fo)),t(`
| attr | value |
| --- | --- |
| on | boolean |
| size | sm (default) lg |
| disabled | boolean |
| change | event |
                    `)])),[[n]]):m("",!0),a.value.base=="w-tab"?u((o(),l("pre",Jt,[t("                        "),e("code",null,s(_o)),t(`
| attr | value |
| --- | --- |
| active | boolean |
| disabled | boolean |
...
| --- | --- |
| change | event |
                    `)])),[[n]]):m("",!0),a.value.base=="w-msg"?u((o(),l("pre",Kt,[t("                        "),e("code",null,s(xo)),t(`
| attr | value |
| --- | --- |
...
| show | content: string, color: success error warning, delay: number |
                    `)])),[[n]]):m("",!0),a.value.base=="w-modal"?u((o(),l("pre",Qt,[t("                        "),e("code",null,s(ko)),t(`
| attr | value |
| --- | --- |
| width | string |
| height | string |
| show | boolean |
                    `)])),[[n]]):m("",!0),a.value.base=="w-dialog"?u((o(),l("pre",Xt,[t("                        "),e("code",null,s(Co)),t(`
| attr | value |
| --- | --- |
| width | string |
| height | string |
| show | boolean |
                    `)])),[[n]]):m("",!0),a.value.base=="confirm"?u((o(),l("pre",Yt,[t("                        "),e("code",null,s(jo)),t(`
| method | value |
| --- | --- |
| Confirm | content:string, callback:function, option={ok: 'ok',cancel: 'cancel'} |
                    `)])),[[n]]):m("",!0),a.value.base=="w-menu"?u((o(),l("pre",Zt,[t("                        "),e("code",null,s(Wo)),t(`
| attr | value |
| --- | --- |
| show | boolean |
...
| --- | --- |
| disabled | boolean |
                    `)])),[[n]]):m("",!0),a.value.base=="w-lazy-loading"?u((o(),l("pre",eo,[t("                        "),e("code",null,s($o)),t(`
| attr | value |
| --- | --- |
                    `)])),[[n]]):m("",!0)]),e("w-input",{style:{width:"300px"},placeholder:"input code show more",value:a.value.code,onChange:g[1]||(g[1]=w=>{a.value.code=w.detail.value})},null,40,to),a.value.code=="js-sh"?(o(),l("div",oo,[e("div",lo,[e("w-tabs",{style:{display:"block",width:"max-content"},value:a.value.highComponent,onChange:g[2]||(g[2]=w=>{a.value.highComponent=w.detail.value})},so,40,ao)]),e("div",null,[a.value.highComponent=="w-table-row"?u((o(),l("pre",io,[t("                        "),e("code",null,s(zo)),t(`
| attr | value |
| --- | --- |
| columns | string |
| hover | boolean |
...
| row | string |
| column | string |
                    `)])),[[n]]):m("",!0),a.value.highComponent=="w-upload"?u((o(),l("pre",co,[t("                        "),e("code",null,s(So)),t(`
| attr | value |
| --- | --- |
| url | string |
| name | string |
...
| disabled | boolean |
| change | event |
                    `)])),[[n]]):m("",!0),a.value.highComponent=="w-player"?u((o(),l("pre",ro,[t("                        "),e("code",null,s(Ao)),t(`
| attr | value |
| --- | --- |
| src | string |
| poster | string |
...
| play |  |
| pause |  |
                    `)])),[[n]]):a.value.highComponent=="w-scroll-loading"?u((o(),l("pre",uo,[t("                        "),e("code",null,s(Lo)),t(`
| attr | value |
| --- | --- |
| change | event |
                    `)])),[[n]]):a.value.highComponent=="w-heart"?u((o(),l("pre",po,[t("                        "),e("code",null,s(qo)),t(`
| attr | value |
| --- | --- |
| value | number |
| disabled | boolean |
| size | sm (default) lg |
| change | event |
                    `)])),[[n]]):a.value.highComponent=="fetch"?u((o(),l("pre",mo,[t("                        "),e("code",null,s(To)),t(`
                    `)])),[[n]]):a.value.highComponent=="w-slide"?(o(),l(v,{key:6},[],64)):m("",!0)])])):m("",!0)])}}},Eo=T(Mo,[["__scopeId","data-v-8718deca"]]),N=h=>(A("data-v-318af7bb"),h=h(),L(),h),Bo={class:"wrap"},Io={class:"content"},Ro=["value"],Do=N(()=>e("w-tab",{value:"doc"},"doc",-1)),Fo=N(()=>e("w-tab",{value:"demo"},"demo",-1)),Po=[Do,Fo],Go={class:"tab-content"},Ho={__name:"WebComponentsPlus",setup(h){ce();const a=p(null),b=p({tab:"doc"});return(g,n)=>(o(),l("div",{class:"wcp-container",onClick:n[1]||(n[1]=(...w)=>{var f,W;return((f=a.value)==null?void 0:f.hideMenu)&&((W=a.value)==null?void 0:W.hideMenu(...w))})},[re(ue,{ref_key:"headerRef",ref:a},null,512),e("div",Bo,[e("div",Io,[e("w-tabs",{value:b.value.tab,onChange:n[0]||(n[0]=w=>{b.value.tab=w.detail.value})},Po,40,Ro),e("div",Go,[b.value.tab=="demo"?(o(),G(At,{key:0})):m("",!0),b.value.tab=="doc"?(o(),G(Eo,{key:1})):m("",!0)])])])]))}},Oo=T(Ho,[["__scopeId","data-v-318af7bb"]]);export{Oo as default};
