 ...
 */const Jl=Symbol();var Xs;(function(e){e.direct="direct",e.patchObject="patch object",e.patchFunction="patch function"})(Xs||(Xs={}));function Ql(){const e=Ni(!0),t=e.run(()=>Fo({}));let r=[],s=[];const o=ns({install(i){o._a=i,i.provide(Jl,o),i.config.globalProperties.$pinia=o,s.forEach(n=>r.push(n)),s=[]},use(i){return!this._a&&!Yl?s.push(i):r.push(i),this},_p:r,_a:null,_e:e,_s:new Map,state:t});return o}const sr={initColor:function(s="#1abc8c"){var t=parseInt(s.substring(1,3),16),r=parseInt(s.substring(3,5),16),s=parseInt(s.substring(5,7),16),o=document.createElement("style");o.innerHTML=`body{
        ...
        *{
        ...
        `}constructor(){super()}connectedCallback(){this.attachShadow({mode:"open"}),this._setHtml(),this._setOptions(),this._event()}static get observedAttributes(){return["col","row"]}attributeChangedCallback(t,r,s){this.shadowRoot&&this._setOptions()}_setHtml(){this.shadowRoot.innerHTML=this._getStyle()+this._getTemplate()}_setOptions(){var t;this._reset(),this.shadowRoot,this.hasAttribute("col")&&(t=this.getAttribute("col"),this.style.gridColumnStart="span "+t),this.hasAttribute("row")&&(t=this.getAttribute("row"),this.style.gridRowStart="span "+t)}_reset(){this.shadowRoot.querySelector("#item").classList.value="item"}_event(){this.shadowRoot}}customElements.define("w-table-item",pa);class ga extends HTMLElement{_getStyle(){return`
        <style>
        *{
            margin: 0;
            padding: 0;
  ...
  * @license MIT
  */const ht=typeof window<"u";function xa(e){return e.__esModule||e[Symbol.toStringTag]==="Module"}const W=Object.assign;function Cr(e,t){const r={};for(const s in t){const o=t[s];r[s]=Ee(o)?o.map(e):e(o)}return r}const Ht=()=>{},Ee=Array.isArray,Sa=/\/$/,Aa=e=>e.replace(Sa,"");function Tr(e,t,r="/"){let s,o={},i="",n="";const c=t.indexOf("#");let l=t.indexOf("?");return c<l&&c>=0&&(l=-1),l>-1&&(s=t.slice(0,l),i=t.slice(l+1,c>-1?c:t.length),o=e(i)),c>-1&&(s=s||t.slice(0,c),n=t.slice(c,t.length)),s=ka(s??t,r),{fullPath:s+(i&&"?")+i+n,path:s,query:o,hash:n}}function Ea(e,t){const r=t.query?e(t.query):"";return t.path+(r&&"?")+r+(t.hash||"")}function Zs(e,t){return!t||!e.toLowerCase().startsWith(t.toLowerCase())?e:e.slice(t.length)||"/"}function qa(e,t,r){const s=t.matched.length-1,o=r.matched.length-1;return s>-1&&s===o&&xt(t.matched[s],r.matched[o])&&bi(t.params,r.params)&&e(t.query)===e(r.query)&&t.hash===r.hash}function xt(e,t){return(e.aliasOf||e)===(t.aliasOf||t)}function bi(e,t){if(Object.keys(e).length!==Object.keys(t).length)return!1;for(const r in e)if(!Ra(e[r],t[r]))return!1;return!0}function Ra(e,t){return Ee(e)?Gs(e,t):Ee(t)?Gs(t,e):e===t}function Gs(e,t){return Ee(t)?e.length===t.length&&e.every((r,s)=>r===t[s]):e.length===1&&e[0]===t}function ka(e,t){if(e.startsWith("/"))return e;if(!e)return t;const r=t.split("/"),s=e.split("/");let o=r.length-1,i,n;for(i=0;i<s.length;i++)if(n=s[i],n!==".")if(n==="..")o>1&&o--;else break;return r.slice(0,o).join("/")+"/"+s.slice(i-(i===s.length?1:0)).join("/")}var Dt;(function(e){e.pop="pop",e.push="push"})(Dt||(Dt={}));var Pt;(function(e){e.back="back",e.forward="forward",e.unknown=""})(Pt||(Pt={}));function La(e){if(!e)if(ht){const t=document.querySelector("base");e=t&&t.getAttribute("href")||"/",e=e.replace(/^\w+:\/\/[^\/]+/,"")}else e="/";return e[0]!=="/"&&e[0]!=="#"&&(e="/"+e),Aa(e)}const Ca=/^[^#]+#/;function Ta(e,t){return e.replace(Ca,"#")+t}function Oa(e,t){const r=document.documentElement.getBoundingClientRect(),s=e.getBoundingClientRect();return{behavior:t.behavior,left:s.left-r.left-(t.left||0),top:s.top-r.top-(t.top||0)}}const _r=()=>({left:window.pageXOffset,top:window.pageYOffset});function Ma(e){let t;if("el"in e){const r=e.el,s=typeof r=="string"&&r.startsWith("#"),o=typeof r=="string"?s?document.getElementById(r.slice(1)):document.querySelector(r):r;if(!o)return;t=Oa(o,e)}else t=e;"scrollBehavior"in document.documentElement.style?window.scrollTo(t):window.scrollTo(t.left!=null?t.left:window.pageXOffset,t.top!=null?t.top:window.pageYOffset)}function eo(e,t){return(history.state?history.state.position-t:-1)+e}const Wr=new Map;function Ha(e,t){Wr.set(e,t)}function Pa(e){const t=Wr.get(e);return Wr.delete(e),t}let za=()=>location.protocol+"//"+location.host;function mi(e,t){const{pathname:r,search:s,hash:o}=t,i=e.indexOf("#");if(i>-1){let c=o.includes(e.slice(i))?e.slice(i).length:1,l=o.slice(c);return l[0]!=="/"&&(l="/"+l),Zs(l,"")}return Zs(r,e)+s+o}function Ia(e,t,r,s){let o=[],i=[],n=null;const c=({state:p})=>{const w=mi(e,location),k=r.value,L=t.value;let F=0;if(p){if(r.value=w,t.value=p,n&&n===k){n=null;return}F=L?p.position-L.position:0}else s(w);o.forEach(P=>{P(r.value,k,{delta:F,type:Dt.pop,direction:F?F>0?Pt.forward:Pt.back:Pt.unknown})})};function l(){n=r.value}function d(p){o.push(p);const w=()=>{const k=o.indexOf(p);k>-1&&o.splice(k,1)};return i.push(w),w}function u(){const{history:p}=window;p.state&&p.replaceState(W({},p.state,{scroll:_r()}),"")}function f(){for(const p of i)p();i=[],window.removeEventListener("popstate",c),window.removeEventListener("beforeunload",u)}return window.addEventListener("popstate",c),window.addEventListener("beforeunload",u),{pauseListeners:l,listen:d,destroy:f}}function to(e,t,r,s=!1,o=!1){return{back:e,current:t,forward:r,replaced:s,position:window.history.length,scroll:o?_r():null}}function Fa(e){const{history:t,location:r}=window,s={value:mi(e,r)},o={value:t.state};o.value||i(s.value,{back:null,current:s.value,forward:null,position:t.length-1,replaced:!0,scroll:null},!0);function i(l,d,u){const f=e.indexOf("#"),p=f>-1?(r.host&&document.querySelector("base")?e:e.slice(f))+l:za()+e+l;try{t[u?"replaceState":"pushState"](d,"",p),o.value=d}catch(w){console.error(w),r[u?"replace":"assign"](p)}}function n(l,d){const u=W({},t.state,to(o.value.back,l,o.value.forward,!0),d,{position:o.value.position});i(l,u,!0),s.value=l}function c(l,d){const u=W({},o.value,t.state,{forward:l,scroll:_r()});i(u.current,u,!0);const f=W({},to(s.value,l,null),{position:u.position+1},d);i(l,f,!1),s.value=l}return{location:s,state:o,push:c,replace:n}}function ja(e){e=La(e);const t=Fa(e),r=Ia(e,t.state,t.location,t.replace);function s(i,n=!0){n||r.pauseListeners(),history.go(i)}const o=W({location:"",base:e,go:s,createHref:Ta.bind(null,e)},t,r);return Object.defineProperty(o,"location",{enumerable:!0,get:()=>t.location.value}),Object.defineProperty(o,"state",{enumerable:!0,get:()=>t.state.value}),o}function $a(e){return typeof e=="string"||e&&typeof e=="object"}function yi(e){return typeof e=="string"||typeof e=="symbol"}const Ne={path:"/",name:void 0,params:{},query:{},hash:"",fullPath:"/",matched:[],meta:{},redirectedFrom:void 0},vi=Symbol("");var ro;(function(e){e[e.aborted=4]="aborted",e[e.cancelled=8]="cancelled",e[e.duplicated=16]="duplicated"})(ro||(ro={}));function St(e,t){return W(new Error,{type:e,[vi]:!0},t)}function Pe(e,t){return e instanceof Error&&vi in e&&(t==null||!!(e.type&t))}const so="[^/]+?",Da={sensitive:!1,strict:!1,start:!0,end:!0},Na=/[.+*?^${}()[\]/\\]/g;function Ba(e,t){const r=W({},Da,t),s=[];let o=r.start?"^":"";const i=[];for(const d of e){const u=d.length?[]:[90];r.strict&&!d.length&&(o+="/");for(let f=0;f<d.length;f++){const p=d[f];let w=40+(r.sensitive?.25:0);if(p.type===0)f||(o+="/"),o+=p.value.replace(Na,"\\$&"),w+=40;else if(p.type===1){const{value:k,repeatable:L,optional:F,regexp:P}=p;i.push({name:k,repeatable:L,optional:F});const M=P||so;if(M!==so){w+=10;try{new RegExp(`(${M})`)}catch(H){throw new Error(`Invalid custom RegExp for param "${k}" (${M}): `+H.message)}}let U=L?`((?:${M})(?:/(?:${M}))*)`:`(${M})`;f||(U=F&&d.length<2?`(?:/${U})`:"/"+U),F&&(U+="?"),o+=U,w+=20,F&&(w+=-8),L&&(w+=-20),M===".*"&&(w+=-50)}u.push(w)}s.push(u)}if(r.strict&&r.end){const d=s.length-1;s[d][s[d].length-1]+=.7000000000000001}r.strict||(o+="/?"),r.end?o+="$":r.strict&&(o+="(?:/|$)");const n=new RegExp(o,r.sensitive?"":"i");function c(d){const u=d.match(n),f={};if(!u)return null;for(let p=1;p<u.length;p++){const w=u[p]||"",k=i[p-1];f[k.name]=w&&k.repeatable?w.split("/"):w}return f}function l(d){let u="",f=!1;for(const p of e){(!f||!u.endsWith("/"))&&(u+="/"),f=!1;for(const w of p)if(w.type===0)u+=w.value;else if(w.type===1){const{value:k,repeatable:L,optional:F}=w,P=k in d?d[k]:"";if(Ee(P)&&!L)throw new Error(`Provided param "${k}" is an array but it is not repeatable (* or + modifiers)`);const M=Ee(P)?P.join("/"):P;if(!M)if(F)p.length<2&&(u.endsWith("/")?u=u.slice(0,-1):f=!0);else throw new Error(`Missing required param "${k}"`);u+=M}}return u||"/"}return{re:n,score:s,keys:i,parse:c,stringify:l}}function Ua(e,t){let r=0;for(;r<e.length&&r<t.length;){const s=t[r]-e[r];if(s)return s;r++}return e.length<t.length?e.length===1&&e[0]===80?-1:1:e.length>t.length?t.length===1&&t[0]===80?1:-1:0}function Ka(e,t){let r=0;const s=e.score,o=t.score;for(;r<s.length&&r<o.length;){const i=Ua(s[r],o[r]);if(i)return i;r++}if(Math.abs(o.length-s.length)===1){if(oo(s))return 1;if(oo(o))return-1}return o.length-s.length}function oo(e){const t=e[e.length-1];return e.length>0&&t[t.length-1]<0}const Wa={type:0,value:""},Va=/[a-zA-Z0-9_]/;function Ya(e){if(!e)return[[]];if(e==="/")return[[Wa]];if(!e.startsWith("/"))throw new Error(`Invalid path "${e}"`);function t(w){throw new Error(`ERR (${r})/"${d}": ${w}`)}let r=0,s=r;const o=[];let i;function n(){i&&o.push(i),i=[]}let c=0,l,d="",u="";function f(){d&&(r===0?i.push({type:0,value:d}):r===1||r===2||r===3?(i.length>1&&(l==="*"||l==="+")&&t(`A repeatable param (${d}) must be alone in its segment. eg: '/:ids+.`),i.push({type:1,value:d,regexp:u,repeatable:l==="*"||l==="+",optional:l==="*"||l==="?"})):t("Invalid state to consume buffer"),d="")}function p(){d+=l}for(;c<e.length;){if(l=e[c++],l==="\\"&&r!==2){s=r,r=4;continue}switch(r){case 0:l==="/"?(d&&f(),n()):l===":"?(f(),r=1):p();break;case 4:p(),r=s;break;case 1:l==="("?r=2:Va.test(l)?p():(f(),r=0,l!=="*"&&l!=="?"&&l!=="+"&&c--);break;case 2:l===")"?u[u.length-1]=="\\"?u=u.slice(0,-1)+l:r=3:u+=l;break;case 3:f(),r=0,l!=="*"&&l!=="?"&&l!=="+"&&c--,u="";break;default:t("Unknown state");break}}return r===2&&t(`Unfinished custom RegExp for param "${d}"`),f(),n(),o}function Ja(e,t,r){const s=Ba(Ya(e.path),r),o=W(s,{record:e,parent:t,children:[],alias:[]});return t&&!o.record.aliasOf==!t.record.aliasOf&&t.children.push(o),o}function Qa(e,t){const r=[],s=new Map;t=lo({strict:!1,end:!0,sensitive:!1},t);function o(u){return s.get(u)}function i(u,f,p){const w=!p,k=Xa(u);k.aliasOf=p&&p.record;const L=lo(t,u),F=[k];if("alias"in u){const U=typeof u.alias=="string"?[u.alias]:u.alias;for(const H of U)F.push(W({},k,{components:p?p.record.components:k.components,path:H,aliasOf:p?p.record:k}))}let P,M;for(const U of F){const{path:H}=U;if(f&&H[0]!=="/"){const se=f.record.path,ie=se[se.length-1]==="/"?"":"/";U.path=f.record.path+(H&&ie+H)}if(P=Ja(U,f,L),p?p.alias.push(P):(M=M||P,M!==P&&M.alias.push(P),w&&u.name&&!no(P)&&n(u.name)),k.children){const se=k.children;for(let ie=0;ie<se.length;ie++)i(se[ie],P,p&&p.children[ie])}p=p||P,l(P)}return M?()=>{n(M)}:Ht}function n(u){if(yi(u)){const f=s.get(u);f&&(s.delete(u),r.splice(r.indexOf(f),1),f.children.forEach(n),f.alias.forEach(n))}else{const f=r.indexOf(u);f>-1&&(r.splice(f,1),u.record.name&&s.delete(u.record.name),u.children.forEach(n),u.alias.forEach(n))}}function c(){return r}function l(u){let f=0;for(;f<r.length&&Ka(u,r[f])>=0&&(u.record.path!==r[f].record.path||!wi(u,r[f]));)f++;r.splice(f,0,u),u.record.name&&!no(u)&&s.set(u.record.name,u)}function d(u,f){let p,w={},k,L;if("name"in u&&u.name){if(p=s.get(u.name),!p)throw St(1,{location:u});L=p.record.name,w=W(io(f.params,p.keys.filter(M=>!M.optional).map(M=>M.name)),u.params&&io(u.params,p.keys.map(M=>M.name))),k=p.stringify(w)}else if("path"in u)k=u.path,p=r.find(M=>M.re.test(k)),p&&(w=p.parse(k),L=p.record.name);else{if(p=f.name?s.get(f.name):r.find(M=>M.re.test(f.path)),!p)throw St(1,{location:u,currentLocation:f});L=p.record.name,w=W({},f.params,u.params),k=p.stringify(w)}const F=[];let P=p;for(;P;)F.unshift(P.record),P=P.parent;return{name:L,path:k,params:w,matched:F,meta:Ga(F)}}return e.forEach(u=>i(u)),{addRoute:i,resolve:d,removeRoute:n,getRoutes:c,getRecordMatcher:o}}function io(e,t){const r={};for(const s of t)s in e&&(r[s]=e[s]);return r}function Xa(e){return{path:e.path,redirect:e.redirect,name:e.name,meta:e.meta||{},aliasOf:void 0,beforeEnter:e.beforeEnter,props:Za(e),children:e.children||[],instances:{},leaveGuards:new Set,updateGuards:new Set,enterCallbacks:{},components:"components"in e?e.components||null:e.component&&{default:e.component}}}function Za(e){const t={},r=e.props||!1;if("component"in e)t.default=r;else for(const s in e.components)t[s]=typeof r=="boolean"?r:r[s];return t}function no(e){for(;e;){if(e.record.aliasOf)return!0;e=e.parent}return!1}function Ga(e){return e.reduce((t,r)=>W(t,r.meta),{})}function lo(e,t){const r={};for(const s in e)r[s]=s in t?t[s]:e[s];return r}function wi(e,t){return t.children.some(r=>r===e||wi(e,r))}const _i=/#/g,ec=/&/g,tc=/\//g,rc=/=/g,sc=/\?/g,xi=/\+/g,oc=/%5B/g,ic=/%5D/g,Si=/%5E/g,nc=/%60/g,Ai=/%7B/g,lc=/%7C/g,Ei=/%7D/g,ac=/%20/g;function gs(e){return encodeURI(""+e).replace(lc,"|").replace(oc,"[").replace(ic,"]")}function cc(e){return gs(e).replace(Ai,"{").replace(Ei,"}").replace(Si,"^")}function Vr(e){return gs(e).replace(xi,"%2B").replace(ac,"+").replace(_i,"%23").replace(ec,"%26").replace(nc,"`").replace(Ai,"{").replace(Ei,"}").replace(Si,"^")}function uc(e){return Vr(e).replace(rc,"%3D")}function dc(e){return gs(e).replace(_i,"%23").replace(sc,"%3F")}function hc(e){return e==null?"":dc(e).replace(tc,"%2F")}function cr(e){try{return decodeURIComponent(""+e)}catch{}return""+e}function fc(e){const t={};if(e===""||e==="?")return t;const s=(e[0]==="?"?e.slice(1):e).split("&");for(let o=0;o<s.length;++o){const i=s[o].replace(xi," "),n=i.indexOf("="),c=cr(n<0?i:i.slice(0,n)),l=n<0?null:cr(i.slice(n+1));if(c in t){let d=t[c];Ee(d)||(d=t[c]=[d]),d.push(l)}else t[c]=l}return t}function ao(e){let t="";for(let r in e){const s=e[r];if(r=uc(r),s==null){s!==void 0&&(t+=(t.length?"&":"")+r);continue}(Ee(s)?s.map(i=>i&&Vr(i)):[s&&Vr(s)]).forEach(i=>{i!==void 0&&(t+=(t.length?"&":"")+r,i!=null&&(t+="="+i))})}return t}function pc(e){const t={};for(const r in e){const s=e[r];s!==void 0&&(t[r]=Ee(s)?s.map(o=>o==null?null:""+o):s==null?s:""+s)}return t}const gc=Symbol(""),co=Symbol(""),xr=Symbol(""),bs=Symbol(""),Yr=Symbol("");function Lt(){let e=[];function t(s){return e.push(s),()=>{const o=e.indexOf(s);o>-1&&e.splice(o,1)}}function r(){e=[]}return{add:t,list:()=>e,reset:r}}function Ue(e,t,r,s,o){const i=s&&(s.enterCallbacks[o]=s.enterCallbacks[o]||[]);return()=>new Promise((n,c)=>{const l=f=>{f===!1?c(St(4,{from:r,to:t})):f instanceof Error?c(f):$a(f)?c(St(2,{from:t,to:f})):(i&&s.enterCallbacks[o]===i&&typeof f=="function"&&i.push(f),n())},d=e.call(s&&s.instances[o],t,r,l);let u=Promise.resolve(d);e.length<3&&(u=u.then(l)),u.catch(f=>c(f))})}function Or(e,t,r,s){const o=[];for(const i of e)for(const n in i.components){let c=i.components[n];if(!(t!=="beforeRouteEnter"&&!i.instances[n]))if(bc(c)){const d=(c.__vccOpts||c)[t];d&&o.push(Ue(d,r,s,i,n))}else{let l=c();o.push(()=>l.then(d=>{if(!d)return Promise.reject(new Error(`Couldn't resolve component "${n}" at "${i.path}"`));const u=xa(d)?d.default:d;i.components[n]=u;const p=(u.__vccOpts||u)[t];return p&&Ue(p,r,s,i,n)()}))}}return o}function bc(e){return typeof e=="object"||"displayName"in e||"props"in e||"__vccOpts"in e}function uo(e){const t=Ae(xr),r=Ae(bs),s=ge(()=>t.resolve(tt(e.to))),o=ge(()=>{const{matched:l}=s.value,{length:d}=l,u=l[d-1],f=r.matched;if(!u||!f.length)return-1;const p=f.findIndex(xt.bind(null,u));if(p>-1)return p;const w=ho(l[d-2]);return d>1&&ho(u)===w&&f[f.length-1].path!==w?f.findIndex(xt.bind(null,l[d-2])):p}),i=ge(()=>o.value>-1&&wc(r.params,s.value.params)),n=ge(()=>o.value>-1&&o.value===r.matched.length-1&&bi(r.params,s.value.params));function c(l={}){return vc(l)?t[tt(e.replace)?"replace":"push"](tt(e.to)).catch(Ht):Promise.resolve()}return{route:s,href:ge(()=>s.value.href),isActive:i,isExactActive:n,navigate:c}}const mc=Jo({name:"RouterLink",compatConfig:{MODE:3},props:{to:{type:[String,Object],required:!0},replace:Boolean,activeClass:String,exactActiveClass:String,custom:Boolean,ariaCurrentValue:{type:String,default:"page"}},useLink:uo,setup(e,{slots:t}){const r=Nt(uo(e)),{options:s}=Ae(xr),o=ge(()=>({[fo(e.activeClass,s.linkActiveClass,"router-link-active")]:r.isActive,[fo(e.exactActiveClass,s.linkExactActiveClass,"router-link-exact-active")]:r.isExactActive}));return()=>{const i=t.default&&t.default(r);return e.custom?i:gi("a",{"aria-current":r.isExactActive?e.ariaCurrentValue:null,href:r.href,onClick:r.navigate,class:o.value},i)}}}),yc=mc;function vc(e){if(!(e.metaKey||e.altKey||e.ctrlKey||e.shiftKey)&&!e.defaultPrevented&&!(e.button!==void 0&&e.button!==0)){if(e.currentTarget&&e.currentTarget.getAttribute){const t=e.currentTarget.getAttribute("target");if(/\b_blank\b/i.test(t))return}return e.preventDefault&&e.preventDefault(),!0}}function wc(e,t){for(const r in t){const s=t[r],o=e[r];if(typeof s=="string"){if(s!==o)return!1}else if(!Ee(o)||o.length!==s.length||s.some((i,n)=>i!==o[n]))return!1}return!0}function ho(e){return e?e.aliasOf?e.aliasOf.path:e.path:""}const fo=(e,t,r)=>e??t??r,_c=Jo({name:"RouterView",inheritAttrs:!1,props:{name:{type:String,default:"default"},route:Object},compatConfig:{MODE:3},setup(e,{attrs:t,slots:r}){const s=Ae(Yr),o=ge(()=>e.route||s.value),i=Ae(co,0),n=ge(()=>{let d=tt(i);const{matched:u}=o.value;let f;for(;(f=u[d])&&!f.components;)d++;return d}),c=ge(()=>o.value.matched[n.value]);er(co,ge(()=>n.value+1)),er(gc,c),er(Yr,o);const l=Fo();return Zt(()=>[l.value,c.value,e.name],([d,u,f],[p,w,k])=>{u&&(u.instances[f]=d,w&&w!==u&&d&&d===p&&(u.leaveGuards.size||(u.leaveGuards=w.leaveGuards),u.updateGuards.size||(u.updateGuards=w.updateGuards))),d&&u&&(!w||!xt(u,w)||!p)&&(u.enterCallbacks[f]||[]).forEach(L=>L(d))},{flush:"post"}),()=>{const d=o.value,u=e.name,f=c.value,p=f&&f.components[u];if(!p)return po(r.default,{Component:p,route:d});const w=f.props[u],k=w?w===!0?d.params:typeof w=="function"?w(d):w:null,F=gi(p,W({},k,t,{onVnodeUnmounted:P=>{P.component.isUnmounted&&(f.instances[u]=null)},ref:l}));return po(r.default,{Component:F,route:d})||F}}});function po(e,t){if(!e)return null;const r=e(t);return r.length===1?r[0]:r}const qi=_c;function xc(e){const t=Qa(e.routes,e),r=e.parseQuery||fc,s=e.stringifyQuery||ao,o=e.history,i=Lt(),n=Lt(),c=Lt(),l=fn(Ne);let d=Ne;ht&&e.scrollBehavior&&"scrollRestoration"in history&&(history.scrollRestoration="manual");const u=Cr.bind(null,m=>""+m),f=Cr.bind(null,hc),p=Cr.bind(null,cr);function w(m,q){let A,C;return yi(m)?(A=t.getRecordMatcher(m),C=q):C=m,t.addRoute(C,A)}function k(m){const q=t.getRecordMatcher(m);q&&t.removeRoute(q)}function L(){return t.getRoutes().map(m=>m.record)}function F(m){return!!t.getRecordMatcher(m)}function P(m,q){if(q=W({},q||l.value),typeof m=="string"){const a=Tr(r,m,q.path),h=t.resolve({path:a.path},q),g=o.createHref(a.fullPath);return W(a,h,{params:p(h.params),hash:cr(a.hash),redirectedFrom:void 0,href:g})}let A;if("path"in m)A=W({},m,{path:Tr(r,m.path,q.path).path});else{const a=W({},m.params);for(const h in a)a[h]==null&&delete a[h];A=W({},m,{params:f(m.params)}),q.params=f(q.params)}const C=t.resolve(A,q),N=m.hash||"";C.params=u(p(C.params));const G=Ea(s,W({},m,{hash:cc(N),path:C.path})),$=o.createHref(G);return W({fullPath:G,hash:N,query:s===ao?pc(m.query):m.query||{}},C,{redirectedFrom:void 0,href:$})}function M(m){return typeof m=="string"?Tr(r,m,l.value.path):W({},m)}function U(m,q){if(d!==m)return St(8,{from:q,to:m})}function H(m){return be(m)}function se(m){return H(W(M(m),{replace:!0}))}function ie(m){const q=m.matched[m.matched.length-1];if(q&&q.redirect){const{redirect:A}=q;let C=typeof A=="function"?A(m):A;return typeof C=="string"&&(C=C.includes("?")||C.includes("#")?C=M(C):{path:C},C.params={}),W({query:m.query,hash:m.hash,params:"path"in C?{}:m.params},C)}}function be(m,q){const A=d=P(m),C=l.value,N=m.state,G=m.force,$=m.replace===!0,a=ie(A);if(a)return be(W(M(a),{state:typeof a=="object"?W({},N,a.state):N,force:G,replace:$}),q||A);const h=A;h.redirectedFrom=q;let g;return!G&&qa(s,C,A)&&(g=St(16,{to:h,from:C}),Je(C,C,!0,!1)),(g?Promise.resolve(g):nt(h,C)).catch(b=>Pe(b)?Pe(b,2)?b:me(b):J(b,h,C)).then(b=>{if(b){if(Pe(b,2))return be(W({replace:$},M(b.to),{state:typeof b.to=="object"?W({},N,b.to.state):N,force:G}),q||h)}else b=$e(h,C,!0,$,N);return Re(h,C,b),b})}function qe(m,q){const A=U(m,q);return A?Promise.reject(A):Promise.resolve()}function nt(m,q){let A;const[C,N,G]=Sc(m,q);A=Or(C.reverse(),"beforeRouteLeave",m,q);for(const a of C)a.leaveGuards.forEach(h=>{A.push(Ue(h,m,q))});const $=qe.bind(null,m,q);return A.push($),dt(A).then(()=>{A=[];for(const a of i.list())A.push(Ue(a,m,q));return A.push($),dt(A)}).then(()=>{A=Or(N,"beforeRouteUpdate",m,q);for(const a of N)a.updateGuards.forEach(h=>{A.push(Ue(h,m,q))});return A.push($),dt(A)}).then(()=>{A=[];for(const a of m.matched)if(a.beforeEnter&&!q.matched.includes(a))if(Ee(a.beforeEnter))for(const h of a.beforeEnter)A.push(Ue(h,m,q));else A.push(Ue(a.beforeEnter,m,q));return A.push($),dt(A)}).then(()=>(m.matched.forEach(a=>a.enterCallbacks={}),A=Or(G,"beforeRouteEnter",m,q),A.push($),dt(A))).then(()=>{A=[];for(const a of n.list())A.push(Ue(a,m,q));return A.push($),dt(A)}).catch(a=>Pe(a,8)?a:Promise.reject(a))}function Re(m,q,A){for(const C of c.list())C(m,q,A)}function $e(m,q,A,C,N){const G=U(m,q);if(G)return G;const $=q===Ne,a=ht?history.state:{};A&&(C||$?o.replace(m.fullPath,W({scroll:$&&a&&a.scroll},N)):o.push(m.fullPath,N)),l.value=m,Je(m,q,A,$),me()}let ke;function lt(){ke||(ke=o.listen((m,q,A)=>{if(!Bt.listening)return;const C=P(m),N=ie(C);if(N){be(W(N,{replace:!0}),C).catch(Ht);return}d=C;const G=l.value;ht&&Ha(eo(G.fullPath,A.delta),_r()),nt(C,G).catch($=>Pe($,12)?$:Pe($,2)?(be($.to,C).then(a=>{Pe(a,20)&&!A.delta&&A.type===Dt.pop&&o.go(-1,!1)}).catch(Ht),Promise.reject()):(A.delta&&o.go(-A.delta,!1),J($,C,G))).then($=>{$=$||$e(C,G,!1),$&&(A.delta&&!Pe($,8)?o.go(-A.delta,!1):A.type===Dt.pop&&Pe($,20)&&o.go(-1,!1)),Re(C,G,$)}).catch(Ht)}))}let Ye=Lt(),qt=Lt(),ee;function J(m,q,A){me(m);const C=qt.list();return C.length?C.forEach(N=>N(m,q,A)):console.error(m),Promise.reject(m)}function V(){return ee&&l.value!==Ne?Promise.resolve():new Promise((m,q)=>{Ye.add([m,q])})}function me(m){return ee||(ee=!m,lt(),Ye.list().forEach(([q,A])=>m?A(m):q()),Ye.reset()),m}function Je(m,q,A,C){const{scrollBehavior:N}=e;if(!ht||!N)return Promise.resolve();const G=!A&&Pa(eo(m.fullPath,0))||(C||!A)&&history.state&&history.state.scroll||null;return No().then(()=>N(m,q,G)).then($=>$&&Ma($)).catch($=>J($,m,q))}const ye=m=>o.go(m);let ue;const at=new Set,Bt={currentRoute:l,listening:!0,addRoute:w,removeRoute:k,hasRoute:F,getRoutes:L,resolve:P,options:e,push:H,replace:se,go:ye,back:()=>ye(-1),forward:()=>ye(1),beforeEach:i.add,beforeResolve:n.add,afterEach:c.add,onError:qt.add,isReady:V,install(m){const q=this;m.component("RouterLink",yc),m.component("RouterView",qi),m.config.globalProperties.$router=q,Object.defineProperty(m.config.globalProperties,"$route",{enumerable:!0,get:()=>tt(l)}),ht&&!ue&&l.value===Ne&&(ue=!0,H(o.location).catch(N=>{}));const A={};for(const N in Ne)A[N]=ge(()=>l.value[N]);m.provide(xr,q),m.provide(bs,Nt(A)),m.provide(Yr,l);const C=m.unmount;at.add(m),m.unmount=function(){at.delete(m),at.size<1&&(d=Ne,ke&&ke(),ke=null,l.value=Ne,ue=!1,ee=!1),C()}}};return Bt}function dt(e){return e.reduce((t,r)=>t.then(()=>r()),Promise.resolve())}function Sc(e,t){const r=[],s=[],o=[],i=Math.max(t.matched.length,e.matched.length);for(let n=0;n<i;n++){const c=t.matched[n];c&&(e.matched.find(d=>xt(d,c))?s.push(c):r.push(c));const l=e.matched[n];l&&(t.matched.find(d=>xt(d,l))||o.push(l))}return[r,s,o]}function Ac(){return Ae(xr)}function Ec(){return Ae(bs)}function qc(e){let t=0;const r=document.createElement("div"),s=document.createElement("img");r.style.transition="all 1s",r.style.position="fixed",r.style.width="100%",r.style.height="100%",r.style.backgroundImage=`url(${e[t]})`,r.style.backgroundSize="cover",r.style.backgroundPosition="center center",s.style.display="none",s.setAttribute("src",e[t<e.length-1?t+1:0]),document.body.prepend(r),document.body.prepend(s),setInterval(()=>{t<e.length-1?t++:t=0,r.style.backgroundImage=`url(${e[t]})`,s.setAttribute("src",e[t<e.length-1?t+1:0])},10*60*1e3)}const Rc={__name:"App",setup(e){return Ac(),Ec(),Zo(t=>{qc(["https://picsum.photos/1920/1080"])}),(t,r)=>(ai(),ui(tt(qi)))}},kc="modulepreload",Lc=function(e){return"/"+e},go={},Qt=function(t,r,s){let o=Promise.resolve();if(r&&r.length>0){const i=document.getElementsByTagName("link");o=Promise.all(r.map(n=>{if(n=Lc(n),n in go)return;go[n]=!0;const c=n.endsWith(".css"),l=c?'[rel="stylesheet"]':"";if(!!s)for(let f=i.length-1;f>=0;f--){const p=i[f];if(p.href===n&&(!c||p.rel==="stylesheet"))return}else if(document.querySelector(`link[href="${n}"]${l}`))return;const u=document.createElement("link");if(u.rel=c?"stylesheet":kc,c||(u.as="script",u.crossOrigin=""),u.href=n,document.head.appendChild(u),c)return new Promise((f,p)=>{u.addEventListener("load",f),u.addEventListener("error",()=>p(new Error(`Unable to preload CSS for ${n}`)))})}))}return o.then(()=>t()).catch(i=>{const n=new Event("vite:preloadError",{cancelable:!0});if(n.payload=i,window.dispatchEvent(n),!n.defaultPrevented)throw i})},Cc=xc({history:ja("/"),routes:[{path:"/",name:"Index",component:()=>Qt(()=>import("./Index-RfZEKDMo.js"),__vite__mapDeps([0,1,2,3]))},{path:"/web-components-plus",name:"WebComponentsPlus",component:()=>Qt(()=>import("./WebComponentsPlus-bOgFZoL2.js"),__vite__mapDeps([4,1,2,5]))},{path:"/dictionary",name:"Dictionary",component:()=>Qt(()=>import("./Dictionary-669TQm4R.js"),__vite__mapDeps([6,1,2,7]))},{path:"/:pathMatch(.*)*",name:"404",component:()=>Qt(()=>import("./NotFound-gQcq9Nw2.js"),__vite__mapDeps([8,1,2,9]))}]});sr.initColor();window.addEventListener("contextmenu",e=>(e.preventDefault(),!1));const Sr=Wl(Rc),Tc=Ql();Sr.config.warnHandler=()=>null;Sr.use(Cc);Sr.use(Tc);Sr.mount("#app");export{Ie as F,he as a,Pc as b,Ic as c,hi as d,Zo as e,Go as f,zc as g,dl as h,sr as i,Dc as j,Fc as k,ui as l,jc as m,$c as n,ai as o,Hc as p,Xl as q,Fo as r,tt as s,Mc as t,Ac as u,Zt as w};
function __vite__mapDeps(indexes) {
  if (!__vite__mapDeps.viteFileDeps) {
    __vite__mapDeps.viteFileDeps = ["assets/Index-RfZEKDMo.js","assets/Header-AdUA-6xe.js","assets/Header-B4J7iWgy.css","assets/Index-g_q4lgUv.css","assets/WebComponentsPlus-bOgFZoL2.js","assets/WebComponentsPlus-eN3s_-oK.css","assets/Dictionary-669TQm4R.js","assets/Dictionary-J-ospy2T.css","assets/NotFound-gQcq9Nw2.js","assets/NotFound-tofmWgTd.css"]
  }
