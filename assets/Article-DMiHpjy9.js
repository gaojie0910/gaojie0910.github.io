import{n as _,a as e,c as s,d as t,w as c,i as n,k as v,u as x,r as g,o as b,b as S,q as u,j as h,p as $,e as w}from"./index-CnizvmBP.js";import{_ as d,H as J}from"./Header-BtwqqEtO.js";import{F as k}from"./Footer-CrAtPQ0J.js";/* empty css                                                                            */const j={},M={class:"container"},C=t("h2",{style:{"text-align":"center"}},"JS2022 some update",-1),I=t("h3",null,"1. String/Array method at(index)",-1),q=t("p",null," [1,2,3].at(-1) // 3 ",-1),O=t("p",null," 'abc'.at(1) // 'b' ",-1),R=t("h3",null,"2. Object.hasOwn(obj, propKey)",-1),B=t("p",null," like in, don't search __proto__, just search self。 ",-1),L=t("h3",null,"3. Private methods field",-1),F=t("code",{class:"code"},`class A {
    field = 1
    #field1 = 1
    static #field2 = 2;
    getField1() {
...
console.log(A.getField2()); // 2
                `,-1);function E(a,p){const r=_("highlight");return e(),s("div",M,[C,I,q,O,R,B,L,t("p",null,[c((e(),s("pre",null,[n("                "),F,n(`
