 ...
 */let ma;const Vn=t=>ma=t,_a=Symbol();function ni(t){return t&&typeof t=="object"&&Object.prototype.toString.call(t)==="[object Object]"&&typeof t.toJSON!="function"}var Jt;(function(t){t.direct="direct",t.patchObject="patch object",t.patchFunction="patch function"})(Jt||(Jt={}));function vu(){const t=To(!0),e=t.run(()=>yt({}));let n=[],r=[];const i=Hn({install(s){Vn(i),i._a=s,s.provide(_a,i),s.config.globalProperties.$pinia=i,r.forEach(o=>n.push(o)),r=[]},use(s){return!this._a&&!yu?r.push(s):n.push(s),this},_p:n,_a:null,_e:t,_s:new Map,state:e});return i}const Ea=()=>{};function ds(t,e,n,r=Ea){t.push(e);const i=()=>{const s=t.indexOf(e);s>-1&&(t.splice(s,1),r())};return!n&&Ro()&&cl(i),i}function xt(t,...e){t.slice().forEach(n=>{n(...e)})}const wu=t=>t();function ri(t,e){t instanceof Map&&e instanceof Map&&e.forEach((n,r)=>t.set(r,n)),t instanceof Set&&e instanceof Set&&e.forEach(t.add,t);for(const n in e){if(!e.hasOwnProperty(n))continue;const r=e[n],i=t[n];ni(i)&&ni(r)&&t.hasOwnProperty(n)&&!we(r)&&!at(r)?t[n]=ri(i,r):t[n]=r}return t}const Su=Symbol();function Au(t){return!ni(t)||!t.hasOwnProperty(Su)}const{assign:nt}=Object;function xu(t){return!!(we(t)&&t.effect)}function Nu(t,e,n,r){const{state:i,actions:s,getters:o}=e,a=n.state.value[t];let l;function u(){a||(n.state.value[t]=i?i():{});const c=Dl(n.state.value[t]);return nt(c,s,Object.keys(o||{}).reduce((h,p)=>(h[p]=Hn(Ne(()=>{Vn(n);const f=n._s.get(t);return o[p].call(f,f)})),h),{}))}return l=ya(t,u,e,n,r,!0),l}function ya(t,e,n={},r,i,s){let o;const a=nt({actions:{}},n),l={deep:!0};let u,c,h=[],p=[],f;const m=r.state.value[t];!s&&!m&&(r.state.value[t]={}),yt({});let v;function N(k){let U;u=c=!1,typeof k=="function"?(k(r.state.value[t]),U={type:Jt.patchFunction,storeId:t,events:f}):(ri(r.state.value[t],k),U={type:Jt.patchObject,payload:k,storeId:t,events:f});const re=v=Symbol();yi().then(()=>{v===re&&(u=!0)}),c=!0,xt(h,U,r.state.value[t])}const x=s?function(){const{state:U}=n,re=U?U():{};this.$patch(ne=>{nt(ne,re)})}:Ea;function R(){o.stop(),h=[],p=[],r._s.delete(t)}function H(k,U){return function(){Vn(r);const re=Array.from(arguments),ne=[],pe=[];function ye(Z){ne.push(Z)}function ge(Z){pe.push(Z)}xt(p,{args:re,name:k,store:F,after:ye,onError:ge});let se;try{se=U.apply(this&&this.$id===t?this:F,re)}catch(Z){throw xt(pe,Z),Z}return se instanceof Promise?se.then(Z=>(xt(ne,Z),Z)).catch(Z=>(xt(pe,Z),Promise.reject(Z))):(xt(ne,se),se)}}const M={_p:r,$id:t,$onAction:ds.bind(null,p),$patch:N,$reset:x,$subscribe(k,U={}){const re=ds(h,k,U.detached,()=>ne()),ne=o.run(()=>kt(()=>r.state.value[t],pe=>{(U.flush==="sync"?c:u)&&k({storeId:t,type:Jt.direct,events:f},pe)},nt({},l,U)));return re},$dispose:R},F=Ft(M);r._s.set(t,F);const j=(r._a&&r._a.runWithContext||wu)(()=>r._e.run(()=>(o=To()).run(e)));for(const k in j){const U=j[k];if(we(U)&&!xu(U)||at(U))s||(m&&Au(U)&&(we(U)?U.value=m[k]:ri(U,m[k])),r.state.value[t][k]=U);else if(typeof U=="function"){const re=H(k,U);j[k]=re,a.actions[k]=U}}return nt(F,j),nt(he(F),j),Object.defineProperty(F,"$state",{get:()=>r.state.value[t],set:k=>{N(U=>{nt(U,k)})}}),r._p.forEach(k=>{nt(F,o.run(()=>k({store:F,app:r._a,pinia:r,options:a})))}),m&&s&&n.hydrate&&n.hydrate(F.$state,m),u=!0,c=!0,F}function Tu(t,e,n){let r,i;const s=typeof e=="function";typeof t=="string"?(r=t,i=s?n:e):(i=t,r=t.id);function o(a,l){const u=Sc();return a=a||(u?Be(_a,null):null),a&&Vn(a),a=ma,a._s.has(r)||(s?ya(r,e,i,a):Nu(r,i,a)),a._s.get(r)}return o.$id=r,o}const jt={initColor:function(r="#1abc8c"){var e=parseInt(r.substring(1,3),16),n=parseInt(r.substring(3,5),16),r=parseInt(r.substring(5,7),16),i=document.createElement("style");i.innerHTML=`body{
        ...
        *{
        ...
        `}constructor(){super()}connectedCallback(){this.attachShadow({mode:"open"}),this._setHtml(),this._setOptions()}static get observedAttributes(){return["color","bgcolor","r","width","percent"]}attributeChangedCallback(e,n,r){this.shadowRoot&&this._setOptions()}_setHtml(){this.shadowRoot.innerHTML=this._getStyle()+this._getTemplate()}_setOptions(){this._reset();var e,n=this.shadowRoot;if(this.hasAttribute("color")?(e=this.getAttribute("color"),n.querySelector("#progress-bar").setAttribute("stroke",e)):n.querySelector("#progress-bar").setAttribute("stroke","var(--wcp-color-base)"),this.hasAttribute("bgcolor")?(e=this.getAttribute("bgcolor"),n.querySelector("#progress-bg").setAttribute("stroke",e)):n.querySelector("#progress-bg").setAttribute("stroke","#eee"),this.hasAttribute("width")?(e=this.getAttribute("width"),n.querySelector("#progress-bg").setAttribute("stroke-width",e),n.querySelector("#progress-bar").setAttribute("stroke-width",e)):(n.querySelector("#progress-bg").setAttribute("stroke-width",10),n.querySelector("#progress-bar").setAttribute("stroke-width",10)),this.hasAttribute("r")?(e=this.getAttribute("r"),n.querySelector("#progress-bg").setAttribute("r",e),n.querySelector("#progress-bar").setAttribute("r",e)):(n.querySelector("#progress-bg").setAttribute("r",50),n.querySelector("#progress-bar").setAttribute("r",50)),this.hasAttribute("percent")){let r=this.getAttribute("percent");100<(r=r<0?0:r)&&(r=100),n.querySelector("#progress-text").innerHTML=r+"%",n.querySelector("#progress-bar").setAttribute("stroke-dashoffset",2*Math.PI*+n.querySelector("#progress-bar").getAttribute("r")*(100-r)/100)}else n.querySelector("#progress-bar").setAttribute("stroke-dashoffset",2*Math.PI*+n.querySelector("#progress-bar").getAttribute("r"));n.querySelector("#progress").style.width=2*+n.querySelector("#progress-bg").getAttribute("r")+ +n.querySelector("#progress-bg").getAttribute("stroke-width")+"px",n.querySelector("#progress").style.height=2*+n.querySelector("#progress-bg").getAttribute("r")+ +n.querySelector("#progress-bg").getAttribute("stroke-width")+"px",n.querySelector("#progress-bg").setAttribute("cx",+n.querySelector("#progress-bg").getAttribute("r")+ +n.querySelector("#progress-bg").getAttribute("stroke-width")/2),n.querySelector("#progress-bg").setAttribute("cy",+n.querySelector("#progress-bg").getAttribute("r")+ +n.querySelector("#progress-bg").getAttribute("stroke-width")/2),n.querySelector("#progress-bar").setAttribute("cx",+n.querySelector("#progress-bar").getAttribute("r")+ +n.querySelector("#progress-bar").getAttribute("stroke-width")/2),n.querySelector("#progress-bar").setAttribute("cy",+n.querySelector("#progress-bar").getAttribute("r")+ +n.querySelector("#progress-bar").getAttribute("stroke-width")/2),n.querySelector("#progress-bar").setAttribute("stroke-dasharray",2*Math.PI*+n.querySelector("#progress-bar").getAttribute("r")),n.querySelector("#progress-bar").setAttribute("transform",`rotate(-90, ${+n.querySelector("#progress-bar").getAttribute("r")+ +n.querySelector("#progress-bar").getAttribute("stroke-width")/2}, ${+n.querySelector("#progress-bar").getAttribute("r")+ +n.querySelector("#progress-bar").getAttribute("stroke-width")/2})`),n.querySelector("#progress-bar").getAttribute("r")<20?n.querySelector("#progress-text").setAttribute("hidden",""):n.querySelector("#progress-text").removeAttribute("hidden"),n.querySelector("#progress-text").style.fontSize=+n.querySelector("#progress-bar").getAttribute("r")/2*1+"px"}_reset(){this.shadowRoot.querySelector("#progress").classList.value="progress"}}customElements.define("w-progress",Hu);class Uu extends HTMLElement{_getStyle(){return`
        <style>
        *{
            margin: 0;
            padding: 0;
