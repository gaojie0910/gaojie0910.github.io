...
console.log(A.getField2()); // 2
                `,-1);function P(a,p){const r=g("highlight");return t(),s("div",M,[C,I,R,L,F,O,E,e("p",null,[c((t(),s("pre",null,[n("                "),N,n(`
...
function pairwise(arr,num) {
    ...
    return res
            ...
            `,-1);function ye(a,p){const r=g("highlight");return t(),s("div",ae,[le,ce,c((t(),s("pre",null,[n("            "),pe,n(`
        `)])),[[r]]),de,c((t(),s("pre",null,[n("            "),he,n(`
        `)])),[[r]]),ue,c((t(),s("pre",null,[n("            "),_e,n(`
         `)])),[[r]]),fe,c((t(),s("pre",null,[n("            "),ge,n(`
        `)])),[[r]]),me,c((t(),s("pre",null,[n("            "),Ae,n(`
        `)])),[[r]])])}const Se=d(oe,[["render",ye]]),ve=a=>($("data-v-214eacac"),a=a(),w(),a),xe={class:"wrap"},be={class:"content"},$e={style:{display:"flex","justify-content":"flex-end"}},we=ve(()=>e("w-icon",{name:"xmark",color:"#666"},null,-1)),Je=[we],ke={style:{"scrollbar-width":"thin","overflow-y":"auto"}},je={__name:"Article",setup(a){const p=x(),r=f(null),o=f({article:"JS2022"}),l=f(null);return b(()=>{const _=p.currentRoute.value.query.article;_&&(o.value.article=_,l.value.setAttribute("show",""))}),(_,i)=>(t(),s("div",{class:"article-container",onClick:i[5]||(i[5]=(...m)=>{var A,y;return((A=r.value)==null?void 0:A.hideMenu)&&((y=r.value)==null?void 0:y.hideMenu(...m))})},[S(J,{ref_key:"headerRef",ref:r},null,512),e("div",xe,[e("div",be,[e("div",{class:"article-box",onClick:i[0]||(i[0]=()=>{o.value.article="JS2022",l.value.setAttribute("show","")})}," JS2022 "),e("div",{class:"article-box",onClick:i[1]||(i[1]=()=>{o.value.article="JS2023",l.value.setAttribute("show","")})}," JS2023 "),e("div",{class:"article-box",onClick:i[2]||(i[2]=()=>{o.value.article="JSStringAndArrayMethod",l.value.setAttribute("show","")})}," JS String And Array Method "),e("div",{class:"article-box",onClick:i[3]||(i[3]=()=>{o.value.article="JSAlgorithm",l.value.setAttribute("show","")})}," JS Algorithm "),e("w-modal",{ref_key:"modalRef",ref:l,width:"min(calc(100% - 10px),1000px)",height:"min(calc(100% - 10px),800px)"},[e("div",$e,[e("w-btn",{type:"text",onClick:i[4]||(i[4]=m=>l.value.removeAttribute("show"))},Je)]),e("div",ke,[o.value.article==="JS2022"?(t(),h(T,{key:0})):u("",!0),o.value.article==="JS2023"?(t(),h(Z,{key:1})):u("",!0),o.value.article==="JSStringAndArrayMethod"?(t(),h(se,{key:2})):u("",!0),o.value.article==="JSAlgorithm"?(t(),h(Se,{key:3})):u("",!0)])],512)])]),S(k)]))}},Le=d(je,[["__scopeId","data-v-214eacac"]]);export{Le as default};
