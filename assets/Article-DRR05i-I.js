var $=Object.defineProperty;var m=e=>{throw TypeError(e)};var k=(e,t,s)=>t in e?$(e,t,{enumerable:!0,configurable:!0,writable:!0,value:s}):e[t]=s;var b=(e,t,s)=>k(e,typeof t!="symbol"?t+"":t,s),A=(e,t,s)=>t.has(e)||m("Cannot "+s);var u=(e,t,s)=>(A(e,t,"read from private field"),s?s.call(e):t.get(e)),h=(e,t,s)=>t.has(e)?m("Cannot add the same private member more than once"):t instanceof WeakSet?t.add(e):t.set(e,s);import{q as F,b as i,c as a,e as o,x as C,j as w,u as R,r as f,d as S,F as j,v as B,w as I,p as N,m as V}from"./index-2p4fj2DR.js";import{_ as x,H as E}from"./Header-BQdfTEQB.js";/* empty css                                                                             */var d,r;class _{constructor(){b(this,"field",1);h(this,d,1)}getField1(){return u(this,d)}static getField2(){return u(this,r)}}d=new WeakMap,r=new WeakMap,h(_,r,2);console.log(new _().field);console.log(new _().getField1());console.log(_.getField2());const D={},H=o("h2",{style:{"text-align":"center"}},"ES2022",-1),M=o("h3",null,"1. String/Array method at(index)",-1),O=o("p",null," [1,2,3].at(-1) // 3 ",-1),q=o("p",null," 'abc'.at(1) // 'b' ",-1),K=o("h3",null,"2. Object.hasOwn(obj, propKey)",-1),P=o("p",null," 和 in 类似，但是不检查原型链__proto__，只检查自身属性。 ",-1),T=o("h3",null,"3. Private methods field",-1),z=o("code",{class:"code"},`class A {
    field = 1
    #field1 = 1
    static #field2 = 2;
    getField1() {
...
console.log(A.getField2()); // 2
                `,-1);function G(e,t,s,c,y,l){const n=F("highlight");return i(),a("div",null,[H,M,O,q,K,P,T,o("p",null,[C((i(),a("pre",null,[w("                "),z,w(`
